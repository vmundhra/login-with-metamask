...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h3>Alright, let's log you in</h3>
        <p>To login, we'll need you to sign a message with your private key.</p>
        <p>
          After hitting the button below, you'll see a dialog box pop up, within
          which will be a randomised message.
        </p>
        <p>
          After signing the message, we will verify your public key, and you can
          continue to participate in our network.
        </p>
